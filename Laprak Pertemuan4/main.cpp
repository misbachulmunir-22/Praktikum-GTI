...
void Mobil()
{
    ...
    glTranslatef(3.1f, 1.5f, 1.0f);
    Balok(0.2f,0.3f,0.5f);
    glPopMatrix();
...
int main(int argc, char **argv)
{
    ...
    glutCreateWindow("Mobil 3D(Misbachul Munir-24060124120031)");
